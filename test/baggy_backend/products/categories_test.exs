  ...
  describe "categories" do
    ...
    test "create_category/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} =
               Products.create_category(attrs(:category, :invalid_attrs))
    end
    ...
    test "update_category/2 with valid data updates the category" do
      ...
      assert {:ok, %Category{} = category} =
               Products.update_category(category, attrs(:category, :update_attrs))
    ...
    test "update_category/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Products.update_category(category, attrs(:category, :invalid_attrs))
