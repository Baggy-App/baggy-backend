defmodule BaggyBackendWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: BaggyBackendWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/baggy_backend_web/templates",
        namespace: BaggyBackendWeb
  ...
  defp view_helpers do
    quote do
      ...
      import BaggyBackendWeb.ErrorHelpers
      import BaggyBackendWeb.Gettext
      alias BaggyBackendWeb.Router.Helpers, as: Routes
    end
  end
